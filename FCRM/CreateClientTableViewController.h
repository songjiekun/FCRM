...
@interface CreateClientTableViewController : UITableViewController<UIPickerViewDelegate,UIActionSheetDelegate,UIImagePickerControllerDelegate,UINavigationControllerDelegate,MyInputViewDelegate>
